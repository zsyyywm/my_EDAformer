# DataB 电线二分类（与 DataA 配置逐项对齐）
# 推荐训练：``python tools/train.py --wire-scheme datab`` 或 ``tools/train_edaformer_wire_datab.py``
